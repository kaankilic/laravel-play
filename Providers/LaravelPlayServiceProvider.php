...
class LaravelPlayServiceProvider extends ServiceProvider
{
	/**
	...
	*/
	...
	{
		$this->publishes([
			__DIR__.'/../Config/config.php' => config_path('laravelplay.php'),
		], 'config');
		$this->mergeConfigFrom(
			__DIR__.'/../Config/config.php', 'laravelplay'
		);
	}
	...
	*/
	public function registerTranslations()
	{
		...
		if (is_dir($langPath)) {
			...
			$this->loadTranslationsFrom(__DIR__ .'/../Resources/lang', 'laravelplay');
		}
	}
